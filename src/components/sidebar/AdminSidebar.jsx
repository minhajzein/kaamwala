...
const SidebarData = [
  { name: "Dashboard", icon: GoHomeFill, path: "/admin/", color: "bg-gray-500" },
  { name: "DataManage", icon: FaDatabase, path: "/admin/datamanage", color: "bg-red-500" },
  { name: "Area Manager", icon: FaLocationDot, path: "/admin/areamanager", color: "bg-green-500" },
  { name: "Restraurant", icon: IoRestaurant, path: "/admin/restaurant", color: "bg-violet-500" },
  { name: "Employee", icon: IoIosMan, path: "/admin/staffs", color: "bg-yellow-500" },
  { name: "Settings", icon: IoSettings, path: "/admin/settings", color: "bg-violet-500" },
];
