...
const Staffs = () => {
  ...
  const data = [
    ...
    { id: 2, empCode: 'E002', name: 'Bob Johnson', jobTitle: 'Data Analyst', location: 'San Francisco', phone: '234-567-8901', hiringStatus: 'notavailabe', action: 'Edit' },
    { id: 3, empCode: 'E003', name: 'Charlie Lee', jobTitle: 'Product Manager', location: 'Chicago', phone: '345-678-9012', hiringStatus: 'available', action: 'Edit' },
    { id: 4, empCode: 'E004', name: 'Dana White', jobTitle: 'UX Designer', location: 'Seattle', phone: '456-789-0123', hiringStatus: 'available', action: 'Edit' },
    ...
    <div>
      ...
      />
          {showEditModal && (
                ...
                id="edit-Staff-admin"
                title="Edit Staff"
                content={<EditStaff handleClose={handleCloseEditModal}/> }
                size = 'big'
                />
            )}
