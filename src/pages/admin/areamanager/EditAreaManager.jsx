...
const EditAreaManager = ({ handleClose }) => {
  ...
  const validationSchema = Yup.object({
    ...
    address: Yup.number().positive("Staff count must be positive").required("Staff count is required"),
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      // Replace with your actual action creator for adding an area manager
