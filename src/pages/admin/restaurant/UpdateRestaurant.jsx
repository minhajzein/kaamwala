...
import { useEditRestaurantMutation } from '../../../redux/admin/api-slices/restaurantApiSlice'
...
const UpdateRestaurant = ({ handleClose, restaurant }) => {
	const { data: locations } = useGetAllLocationsQuery()
	const [updateRestaurant, { isLoading }] = useEditRestaurantMutation()
